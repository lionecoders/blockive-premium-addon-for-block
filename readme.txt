...
1. Upload the plugin files to the `/wp-content/plugins/blockive-premium-addon-for-block` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress.
3. You can now find the "Blockive" category in your Gutenberg block inserter.
...
Yes, blockive-premium-addon-for-block is designed to work seamlessly with any standard WordPress theme that supports the Gutenberg editor.
