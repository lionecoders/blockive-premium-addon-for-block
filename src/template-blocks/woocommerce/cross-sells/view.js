/**
 * Frontend slider initialization for the Cross Sells Template Block.
 * Identical to the Related Products / Upsells view.js - each dynamic
 * block's viewScript is its own webpack entry, so this small script is
