...
const SAMPLE_TEXT = __(
	'A short, punchy summary of the product goes here — highlighting the key benefit in a sentence or two.',
...
export default function Edit( { attributes, setAttributes } ) {
	...
	const previewHtml = record?.excerpt?.rendered || '';

	const blockProps = useBlockProps( {
		className: 'bpafb-tb-product-short-description',
		style: {
