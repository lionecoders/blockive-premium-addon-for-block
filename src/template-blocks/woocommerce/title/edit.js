...
export default function Edit( { attributes, setAttributes } ) {
	...
	// Forced to 'product' regardless of the template's configured Template
	// Type - this block only makes sense inside a Product template.
	...
	const blockProps = useBlockProps( {
		className: 'bpafb-tb-product-title',
		style: {
		...
		<>
			...
			<TagName { ...blockProps }>
				{ isResolving && ! previewTitle
					...
					: previewTitle || __( 'Sample Product Name', 'blockive-premium-addon-for-block' ) }
			</TagName>
		</>
	);
}
