...
/**
 * Render function for the Event Image Template Block.
 *
...
$bpafb_figure_classes = ['bpafb-tb-event-image'];
if ($bpafb_overlay_color) {
...
if ($bpafb_has_thumbnail) {
	...
	echo '<div class="bpafb-tb-event-image-placeholder" aria-hidden="true"></div>';
}
